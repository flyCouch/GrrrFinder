...
#ifndef STASSID
#define STASSID "NRN_951"
#define STAPSK  "nrnnrn613"
#endif

char *menu[8] = {"Grrr Finder", "Connect", "Clock", "DrawLines", "Theremin", "Calculator", "Abacus", "Chess"};
...
void Chess() {
  ...
  /*
    ...
    It is useful to have the enemy King in check every move.
    }
